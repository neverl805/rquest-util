...
macro_rules! mod_generator {
    (
        ...
        pub(crate) mod $mod_name {
            ...
            pub fn emulation(option: EmulationOption) -> rquest::EmulationProvider {
            ...
            pub fn build_emulation(
                ...
                let tls_cfg: TlsConfig = $tls_options;
...
mod_generator!(
    ...
    [
        ...
        (
            Android,
            "Mozilla/5.0 (Android 13; Mobile; rv:146.0) Gecko/145.0 Firefox/146.0"
        ),
        (
            IOS,
